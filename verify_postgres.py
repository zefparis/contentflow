...
def test_connection():
    try:
        ...
        with conn.cursor() as cur:
            ...
            print_header("Checking 'jobs' table")
            cur.execute("""
                SELECT EXISTS (
            ...
            if cur.fetchone()[0]:
                ...
                if cur.fetchone()[0]:
                    ...
                    print("\n❌ 'idempotency_key' column is missing")
                ...
                print("\nCreating 'jobs' table with required schema...")
                ...
                try:
                    ...
                    """)
                    print("✅ 'jobs' table created successfully with required schema")
                except Exception as e:
